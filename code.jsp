...
<!--http://localhost:8080/Regular user/roughdraft.jsp  
	...
	http://localhost:8080/Regular user/Timecard sApproval.jsp
...
a{
	...
	<h1 class="sheet">&emsp;&emsp;Job Code Management</h1>

<br>


<h2 id="mytimesheet"><a href="edit.html?id=${job.jobId}">Add new timesheet</a> 
<br><br><br><br><br>	
